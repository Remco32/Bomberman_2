 ...
 */
public class diminishingEGreedy extends AIHandler {
    ...
    public diminishingEGreedy(GameWorld world, int manIndex, NNSettings setting, GameSettings gSet) {
    ...
    public void AddMoveToBuffer() {
        ...
        //double currExploration = explorationChance*(1-getGenerationError().size()*getGenerationPoints().size()/(double)( getGenerationSize()*getEpochSize()));
        ...
        if (currExploration > value && !testing) {
